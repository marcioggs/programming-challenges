...
public class SolutionTest {
    ...
    public void shouldIgnoreStringsWithNonAlphanumericalChars() {
        assertEquals(7, new Solution().getLongestValidPasswordLength("test 5 a0A pass007 ?xy1aaaaaaaaa"));
    }

    @Test
    public void shouldIgnoreStringsWithOddNumberOfLetters() {
        assertEquals(7, new Solution().getLongestValidPasswordLength("test 5 a0A pass007 aaaaaaaaaaaaa"));
    }

    @Test
    public void shouldIgnoreStringsWithEvenNumberOfDigits() {
        assertEquals(7, new Solution().getLongestValidPasswordLength("test 5 a0A pass007 111111111111"));
    }
