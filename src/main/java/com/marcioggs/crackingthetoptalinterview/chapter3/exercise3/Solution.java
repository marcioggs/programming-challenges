...
/**
 * Duplicate characters: Find the top most repeated character in a string. For instance, given a
 * string 'hello world', the top most repeated character is 'l' because it can be found 3 times in
 * the string.
 */
