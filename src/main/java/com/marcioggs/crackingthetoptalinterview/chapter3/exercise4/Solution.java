...
/**
 * Balanced brackets: given a mathematical operation,find out if the brackets are placed such that the equation is valid.
 * There are 3 types of brackets: (,[,{. For example, ([4*{2+3}]) is balanced, but {[3} is unbalanced.
 */
