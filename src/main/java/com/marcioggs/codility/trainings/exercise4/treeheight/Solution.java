 ...
 * path from root to leaf) is within the range [0..500]. Copyright 2009–2022 by Codility Limited.
 * All Rights Reserved. Unauthorized copying, publication or disclosure prohibited.
 * <p>
 * <a href="https://app.codility.com/programmers/trainings/4/tree_height/">Codility</a>
 */
public class Solution {
  ...
  private void visit(Tree tree) {
    ...
    if (tree.l == null && tree.r == null) {
      ...
      tree.x = Math.max(tree.l == null ? 0 : tree.l.x, tree.r == null ? 0 : tree.r.x) + 1;
    }
