...
/**
 * Platform: HackerRank
 * Challenge: Practice > Interview Preparation Kit > Arrays > 2D Array - DS
...
public class Solution {
    ...
    /**
     * Return the maximum hourglass sum for a given array.
     * Ideally the hourglassRelativeIndexes should be received as a parameter, but was kept within the class to run on
    ...
    /**
     * Get the max value of a specific dimension in a two dimension array array.
     * e.g.: Array: {{5, 6}, {7, 8}}
     *       Dimension: 1
     *       Max value: 8
     *
